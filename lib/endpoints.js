...
module.exports = {
    ...
    getWeaponsDetails: (id, lang) => `${endpoint}loot/get?id=${id}&lang=${lang}`,
    listWeaponsSpawnChance: mode => `${endpoint}loot/chances?mode=${mode}`,
    ...
    listFishes: lang => `${endpoint}/loot/fish?lang=${lang}`,
    getPlayerFishesStats: id => `${endpoint}/stats/fish?accountId=${id}`
};
